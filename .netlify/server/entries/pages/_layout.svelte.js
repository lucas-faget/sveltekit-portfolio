...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<header class="absolute top-0 left-0 h-20 w-full p-4 flex justify-between items-center"><div class="h-12 w-12" data-svelte-h="svelte-1ii9p11"><img class="h-full w-full"${add_attribute("src", logo, 0)} alt="SvelteKit"></div> <nav><ul class="flex gap-4"><li${add_attribute("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} class="svelte-klwya7"><a href="/" class="svelte-klwya7">${validate_component(Button, "Button").$$render($$result, { text: "Home", rounded: true, dark: true }, {}, {})}</a></li> <li${add_attribute("aria-current", $page.url.pathname === "/about" ? "page" : void 0, 0)} class="svelte-klwya7"><a href="/about" class="svelte-klwya7">${validate_component(Button, "Button").$$render($$result, { text: "About", rounded: true, dark: true }, {}, {})}</a></li> <li${add_attribute("aria-current", $page.url.pathname === "/projects" ? "page" : void 0, 0)} class="svelte-klwya7"><a href="/projects" class="svelte-klwya7">${validate_component(Button, "Button").$$render(
    $$result,
    {
      text: "Projects",
      rounded: true,
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="flex flex-col justify-center items-center p-4" data-svelte-h="svelte-1h79jzp"><p>Site web conçu et réalisé par Lucas Faget avec SvelteKit</p></footer>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex flex-col min-h-screen">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="flex-1 box-border">${slots.default ? slots.default({}) : ``}</main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div>`;
});
export {
  Layout as default
};
